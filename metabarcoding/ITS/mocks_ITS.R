...
path = "/home/galati/Téléchargements/export_ITS_deblur/export"
setwd(path)
...
path = "/home/galati/Téléchargements/export_ITS_dada2/export"
setwd(path)
...
tax_tot<-rbind(taxa_ITS_deblur,taxa_ITS_vsearch)
...
library(stringr)
tax_split <- str_split_fixed(comb_tax$OTUID,";k_.__",8)
...
write.table(x = res, file = "/home/galati/Téléchargements/table_mocks_ITS_tot.tsv",sep="\t",dec=",",row.names = F)
#Table OTU
write.table(x = otu, file = "/home/galati/Téléchargements/table_mocks_ITS_otu.tsv",sep="\t",dec=",",row.names = F)
#Table Mocks
write.table(x = tax, file = "/home/galati/Téléchargements/table_mocks_ITS_tax.tsv",sep="\t",dec=",",row.names = F)
